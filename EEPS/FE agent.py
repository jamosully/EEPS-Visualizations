# -*- coding: utf-8 -*-
"""
This is a expansion of the original agent design in EEPS with Free Energy and Active Inference from FEPS (REF HERE)
"""
...
class FEAgent(object):
    ...
    def fe_softmax(self, prob, beta, temp=1, dimensions=np.array([0,0])):

        """
        Based on the function in FEPS, takes a clip_space/ECM
        """
