...
Agent design based on the multi-excitation projective simulation
"""

class mePS_Agent(object):
    ...
    def action_selection(self, percept, action_set_t, clip = None): # Ok!
        ...
        # With the percept, find relevent transitions and h-values
        relevent_h_vector = [clip[percept][action]['weight'] for action in action_set_t]
        
        probability_distr = self.softmax(relevent_h_vector, self.beta_h)
